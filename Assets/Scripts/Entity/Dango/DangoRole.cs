...
class DangoRole
{
    ...
    private DangoRole()
    {
        posRoles = new()
    {
        new Role<int>(new int[]{0,0,0},POSROLE_MONOCOLOR,20),
        new Role<int>(new int[]{0,0,0,0},POSROLE_MONOCOLOR,35),
        new Role<int>(new int[]{0,0,0,0,0},POSROLE_MONOCOLOR,45),
        new Role<int>(new int[]{0,0,0,0,0,0},POSROLE_MONOCOLOR,72),
        new Role<int>(new int[]{0,0,0,0,0,0,0},POSROLE_MONOCOLOR,0),
        new Role<int>(new int[]{0,1,0},POSROLE_LINE_SYMMETRY,13),
        new Role<int>(new int[]{0,1,1,0},POSROLE_LINE_SYMMETRY,28),
        new Role<int>(new int[]{0,0,1,0,0},POSROLE_LINE_SYMMETRY,35),
        new Role<int>(new int[]{0,1,0,1,0},POSROLE_LINE_SYMMETRY,35),
        new Role<int>(new int[]{0,1,1,1,0},POSROLE_LINE_SYMMETRY,35),
        new Role<int>(new int[]{0,1,2,1,0},POSROLE_LINE_SYMMETRY,35),
        new Role<int>(new int[]{0,0,1,1,0,0},POSROLE_LINE_SYMMETRY,60),
        new Role<int>(new int[]{0,1,0,0,1,0},POSROLE_LINE_SYMMETRY,60),
        new Role<int>(new int[]{0,1,1,1,1,0},POSROLE_LINE_SYMMETRY,60),
        new Role<int>(new int[]{0,1,2,2,1,0},POSROLE_LINE_SYMMETRY,60),
        new Role<int>(new int[]{0,0,0,1,0,0,0},POSROLE_LINE_SYMMETRY,0),
        new Role<int>(new int[]{0,0,1,0,1,0,0},POSROLE_LINE_SYMMETRY,0),
        new Role<int>(new int[]{0,0,1,1,1,0,0},POSROLE_LINE_SYMMETRY,0),
        new Role<int>(new int[]{0,0,1,2,1,0,0},POSROLE_LINE_SYMMETRY,0),
        new Role<int>(new int[]{0,1,0,0,0,1,0},POSROLE_LINE_SYMMETRY,0),
        new Role<int>(new int[]{0,1,0,1,0,1,0},POSROLE_LINE_SYMMETRY,0),
        new Role<int>(new int[]{0,1,0,2,0,1,0},POSROLE_LINE_SYMMETRY,0),
        new Role<int>(new int[]{0,1,1,0,1,1,0},POSROLE_LINE_SYMMETRY,0),
        new Role<int>(new int[]{0,1,1,1,1,1,0},POSROLE_LINE_SYMMETRY,0),
        new Role<int>(new int[]{0,1,1,2,1,1,0},POSROLE_LINE_SYMMETRY,0),
        new Role<int>(new int[]{0,1,2,0,2,1,0},POSROLE_LINE_SYMMETRY,0),
        new Role<int>(new int[]{0,1,2,1,2,1,0},POSROLE_LINE_SYMMETRY,0),
        new Role<int>(new int[]{0,1,2,2,2,1,0},POSROLE_LINE_SYMMETRY,0),
        new Role<int>(new int[]{0,1,2,3,2,1,0},POSROLE_LINE_SYMMETRY,0),
        new Role<int>(new int[]{0,1,0,1},POSROLE_LOOP,28),
        new Role<int>(new int[]{0,0,1,0,0,1},POSROLE_LOOP,60),
        new Role<int>(new int[]{0,1,1,0,1,1},POSROLE_LOOP,60),
        new Role<int>(new int[]{0,1,2,0,1,2},POSROLE_LOOP,60),
        new Role<int>(new int[]{0,1,0,1,0,1},POSROLE_LOOP,60),
        new Role<int>(new int[]{0,0,1,1},POSROLE_DIVIDED_INTO_TWO,28),
        new Role<int>(new int[]{0,0,0,1,1,1},POSROLE_DIVIDED_INTO_TWO,60),
        new Role<int>(new int[]{0,0,1,1,2,2},POSROLE_DIVIDED_INTO_THREE,60),
    };
    }

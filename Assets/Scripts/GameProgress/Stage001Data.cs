...
public class Stage001Data
{
    ...
    public void AddQuest()
    {
        ...
        List<QuestData> quest = new()
        {
            ...
            //D5ã¸
            questManager.Creater.CreateQuestDestination(6, FloorManager.Floor.floor10,false, "é“à‚Ì’†‘w‚ÉŒü‚©‚¦", 30f, true, false, 7, 8),

            //D5ã¸
            questManager.Creater.CreateQuestCreateRole(7, new QuestCreateRole.EstablishRole(true,false,DangoColor.Orange), 2, 0, "òF‚Ì’cq‚ğŠÜ‚ñ‚Å–ğ‚ğ2‰ñì‚ê", 30f, true, false,9),
            questManager.Creater.CreateQuestCreateRole(8, new QuestCreateRole.EstablishRole(true,false,DangoColor.Green), 2, 0, "—ÎF‚Ì’cq‚ğŠÜ‚ñ‚Å–ğ‚ğ2‰ñì‚ê", 30f, true, false,9),
